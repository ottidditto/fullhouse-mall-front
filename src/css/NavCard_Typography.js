...
/* NavCard의 ProductCategory 컴포넌트에 사용되는 하위컴포넌트와 스타일 */
...
function NavCard_Typography(props) {
...
export default styled(NavCard_Typography)(styles);